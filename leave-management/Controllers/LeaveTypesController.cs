    ...
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<ActionResult> Create(LeaveTypeVM model)
        {
            try
            {
                ...
                return RedirectToAction(nameof(Index)); //Redirect to the list. (Everything is good).
            }
            catch
            {
                ModelState.AddModelError("", "Something Went Wrong...");
        ...
        public async Task<ActionResult> Edit(int id)
        {
            ...
            var model = _mapper.Map<LeaveTypeVM>(leavtype); //mapping to LeaveTypeVM.
            return View(model);
        }
        ...
        public async Task<ActionResult> Edit(LeaveTypeVM model)
        {
            try
            {
                ...
                var leaveType = _mapper.Map<LeaveType>(model); ///mapping from LeaveTypeVM to LeaveType
        ...
        // Now We don't use the Post Delete, We only use GET.
        [HttpPost] 
        [ValidateAntiForgeryToken]
